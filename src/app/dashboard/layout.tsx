...
// NAV — Alerts lives in the top header bell; bottom nav frees that slot for Feed.
const NAV_ITEMS = [
  ...
  // Contacts URL kept for existing bookmarks; label shows as "Allies" per v2 rebrand.
