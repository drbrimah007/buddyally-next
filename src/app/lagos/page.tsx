// City-targeted landing page for Lagos. Mirrors /abuja exactly — same
// sky-blue accent, big tracking-tight headlines, glass Buddy Pulse preview,
// soft cards, dark "why" panel — with Lagos-specific neighborhoods (Ikeja,
// Victoria Island, Lekki, Yaba, Surulere, Ikoyi, Ajah) and signal copy
// (Lagos → Ibadan rides, Lekki pickup ball, Yaba help, etc.).

import Link from 'next/link'
import type { Metadata } from 'next'

export const metadata: Metadata = {
  title: 'BuddyAlly in Lagos — Rides, help, events, and people nearby',
  description:
    'Find rides going your way across Lagos, share local help, post events, and connect with people moving through Ikeja, Victoria Island, Lekki, Yaba, Surulere, and more.',
  alternates: { canonical: 'https://buddyally.com/lagos' },
  openGraph: {
    title: 'BuddyAlly in Lagos',
    description: 'Rides, local help, events, and people already moving around Lagos.',
    url: 'https://buddyally.com/lagos',
    type: 'website',
    images: ['/og-image.png'],
  },
  twitter: {
  ...
  return (
    <div style={{ background: '#f4f5f7', color: '#111827', overflow: 'hidden' }}>
      <div style={wrap}>
        ...
        <main style={hero}>
          <div>
            <span style={pill}><span style={dot} /> Buddy Pulse · Lagos</span>
            <h1 style={h1}>
              Someone&apos;s going your way, <span style={{ color: '#3293cb' }}>Lagos.</span>
            </h1>
            <p style={subhead}>
              Share rides through traffic, swap local help, post events, and connect with the people already moving across your side of the city.
            </p>
            <div style={ctaRow}>
          ...
          <aside id="pulse" style={pulseCard}>
            <div style={pulseInner}>
              ...
              <div style={pulseTop}>
                <div style={pulseLabel}>Buddy Pulse Lagos</div>
                <div style={livePill}>Live preview</div>
              </div>
              <div style={notice}>
                <div style={noticeType}><span style={dot} /> Ride Share</div>
                <h2 style={noticeH2}>Heading from Lekki to Ikeja before traffic builds.</h2>
                <p style={noticeP}>One seat open. Leaving in 15. Drop you near GRA if it works.</p>
                <div style={noticeMeta}>📍 Lekki Phase 1 · 2 min ago</div>
              </div>
              <div style={dots}>
        ...
        <section style={section}>
          <h2 style={sectionTitle}>What&apos;s moving in Lagos?</h2>
          <p style={sectionSub}>
            BuddyAlly is for real local motion: rides through go-slow, events, help, shared plans, and people already nearby.
          </p>
          <div style={cards}>
            <div style={card}>
              <div style={iconBox}>🚗</div>
              <h3 style={cardH3}>Going Your Way</h3>
              <p style={cardP}>Find people already crossing the bridge or heading mainland → island, and split the run.</p>
            </div>
            <div style={card}>
              <div style={iconBox}>📍</div>
              <h3 style={cardH3}>Buddy Pulse</h3>
              <p style={cardP}>See what&apos;s happening near Ikeja, Victoria Island, Lekki, Yaba, Surulere, Ikoyi, and Ajah.</p>
            </div>
            <div style={card}>
              <div style={iconBox}>🤝</div>
              <h3 style={cardH3}>Help &amp; Community</h3>
              <p style={cardP}>Connect around local needs, favors, skills, and everyday support across your area.</p>
            </div>
          </div>
        </section>
        ...
        <section style={section}>
          <div style={whyGrid}>
            <div style={whyBox}>
              ...
              <p style={whyBoxP}>
                Lagos is enormous and tightly woven — traffic, hustle, family, work, and everything in between. BuddyAlly turns the people already moving around you into something useful.
              </p>
            </div>
            <div style={bullets}>
              <div style={bullet}>
              ...
              <div style={bullet}>
                ...
                <p style={bulletP}>BuddyAlly is free for everyday rides, help, and meet-ups across Lagos.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section style={section}>
          <div style={referral}>
            <h2 style={referralH2}>Bring Lagos closer.</h2>
            <p style={referralP}>Join, post what you&apos;re doing, and invite friends who move through your side of the city.</p>
...
const SAMPLE_SIGNALS: { tag: string; title: string; body: string; where: string }[] = [
  { tag: 'Ride',   title: 'Lagos → Ibadan Saturday',     body: 'Two seats open. Leaving around 7am to beat traffic.', where: 'Ikeja' },
  { tag: 'Sports', title: 'Pickup football this evening', body: 'Need four more for a small-side game on the turf.',  where: 'Lekki Phase 1' },
  { tag: 'Help',   title: 'Need help moving boxes',       body: 'Quick lift in the building — fuel/transport sorted.', where: 'Yaba' },
  { tag: 'Event',  title: 'Extra concert ticket tonight', body: 'Free if you can meet at the gate by 8pm.',            where: 'Victoria Island' },
]
