          ...
          {tab === 'details' && (
            <>
              ...
              {/* Safety + trust-badges explainer + link to /trust-and-safety —
                  unified via the shared SafetyBanner so every surface ships
                  the SAME complete content. Was previously an inline
                  abridged copy that lacked the trust-badge section. */}
